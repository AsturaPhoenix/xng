...
public class DistributionTest {
    ...
    public void testDefault() {
        assertThat(new UnimodalHypothesis(Synapse.THRESHOLD + Node.THRESHOLD_MARGIN).getMin())
                .isGreaterThanOrEqualTo(Synapse.THRESHOLD);
        assertThat(new UnimodalHypothesis(Synapse.THRESHOLD - Node.THRESHOLD_MARGIN).getMax())
    ...
    public void testBounding() {
        ...
        for (int i = 0; i < 1000; ++i) {
            assertThat(distribution.generate()).isBetween(distribution.getMin(), distribution.getMax());
        }
    }
    ...
    public void testAddToTail() {
        ...
        // better results.
        assertEquals(.5f, distribution.getMode(), Float.MIN_VALUE, distribution.toString());
    }
