...
public class DistributionTest {
  ...
  public void testDefault() {
    assertThat(new UnimodalHypothesis(Prior.DEFAULT_COEFFICIENT).getMin())
        .isGreaterThanOrEqualTo(ThresholdIntegrator.THRESHOLD);
    assertThat(new UnimodalHypothesis(ThresholdIntegrator.THRESHOLD -
        Prior.THRESHOLD_MARGIN).getMax())
