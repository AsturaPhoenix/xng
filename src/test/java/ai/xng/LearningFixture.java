...
// if (runs >= maxRuns) {
// Assertions.fail(String.format("Required at least %s consecutive successes by
// %s runs.%s",
// requiredConsecutiveSuccesses, maxRuns, lastFailure == null ? "" : "Last
// failure: " + lastFailure));
// }
// return consecutiveSuccesses < requiredConsecutiveSuccesses;
// }

// public void reinforce(final boolean pass, final Context context, final float
// passWeight, final float failWeight) {
